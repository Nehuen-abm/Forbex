      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-10 col-md-offset-1 col-sm-12">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-4 wow bounceIn"  data-wow-delay="0.5s"> 
                  <img src="<?php echo site_url('assets/images/web/fbx-ta.jpg');?>" class="img-responsive" />
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4  wow bounceIn"  data-wow-delay="0.6s">
                  <img src="<?php echo site_url('assets/images/web/fbx-tb.jpg');?>" class="img-responsive"  />
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4  wow bounceIn"  data-wow-delay="0.7s" > 
                ...
                <div class="row">
                     ...
                     <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                      ...
                      <figure class="aim pull-left" >
                        ...
                        <img alt="Prueba" class="img-responsive wow fadeInDown capa-1" src="<?php echo site_url('assets/images/capa_1.png'); ?>" data-wow-delay="0.5s"/>
                        <img alt="Prueba" class="img-responsive wow fadeInDown capa-2" src="<?php echo site_url('assets/images/capa_2.png'); ?>" data-wow-delay="0.6s"/>
                        <img alt="Prueba" class="img-responsive wow fadeInDown capa-3" src="<?php echo site_url('assets/images/capa_3.png'); ?>" data-wow-delay="0.7s"/>
                        ...
                        <img alt="Prueba" class="img-responsive wow fadeIn     capa-5" src="<?php echo site_url('assets/images/logo_tencate.png'); ?> " data-wow-delay="0.9s"/>
                      </figure>
                        
                    </div>
                      <div class="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                        <div class="descripcion  wow fadeInDown" data-wow-delay="1.1s">
    ...
    <section class="box-fbx-gris bg-arrow fbx-aim-b ">
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  wow fadeInDown " data-wow-delay="0.5s">
             ...
             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 wow fadeInRight"  data-wow-delay="0.6s">
                  <p  > <img src="<?php echo site_url('assets/images/web/img-aim-b.jpg');?> " class="img-responsive"/></p>
            </div>
            </div>
          </div>
    </section>
    <section>
       <div class="container">
                <div class="row">
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 wow fadeInDown" data-wow-delay="0.1s">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 galeria">
           <div class="col-md-9 col-sm-9 col-xs-9 wow fadeIn " >
             <img src="<?php echo site_url('assets/images/imagenes obras/01_river.jpg'); ?>"   class="img-responsive">

           
               <div class="col-md-3 col-sm-3 col-xs-3 wow fadeIn "><img src="<?php echo site_url('assets/images/imagenes obras/02_grecia.jpg'); ?>"  class="img-responsive"></div>
               <div class="col-md-9 col-sm-9  col-xs-3 wow fadeIn  "><img src="<?php echo site_url('assets/images/imagenes obras/3.jpg'); ?>"          class="img-responsive"></div>
           ...
           <div class="col-md-6 col-sm-6   col-xs-6 wow fadeIn " >
